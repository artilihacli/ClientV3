package ChargeurTransformice_fla.Packets {
	...
	public class InboundPacket extends ByteArray {

        public function InboundPacket(C:int, CC:int) {
            super();
            this.writeByte(C);
            this.writeByte(CC);
        }
        ...
        public function handle():void {
            //trace("InboundPacket handled with data: " + this.toString());
            SocketHandler.handleInboundPacket(this);
        }
